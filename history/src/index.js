...
//
function setupHandlers1(app, db, messageChannel) {
...
function setupHandlers2(app, db, messageChannel) {
...
function startHttpServer(db, messageChannel) {
    return new Promise(resolve => { // Wrap in a promise so we can be notified when the server has started.
        ...
        getStuff(setupHandlers1(app, db, messageChannel));
        getStuff(setupHandlers2(app, db, messageChannel));
